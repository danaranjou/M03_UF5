...
public class ProductView extends javax.swing.JDialog {
    ...
    public void addProductView() {
        ...
        if (!product) {
            ...
            shop.numberProducts++;
            JOptionPane.showMessageDialog(this, "El producto ha sido añadido correctamente", "", JOptionPane.PLAIN_MESSAGE);

            this.dispose();
        } else {
            JOptionPane.showMessageDialog(this, "El producto ya existe en el inventario.", "", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void addStockView() {
        ...
        if (product != null) {
            ...
            JOptionPane.showMessageDialog(this, "El stock del producto " + name + " ha sido actualizado ", "", JOptionPane.PLAIN_MESSAGE);
            this.dispose();
        } else {
            ...
            if (prod != null) {
                for (int i = 0; i < shop.inventory.size(); i++) {
                    if (shop.inventory.get(i) != null && shop.inventory.get(i).getName().equalsIgnoreCase(name)) {
                        ...
                        JOptionPane.showMessageDialog(this, "El producto " + name + " ha sido eliminado ", "", JOptionPane.PLAIN_MESSAGE);
                    }
                }
            }
        } else {
